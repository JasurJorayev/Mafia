...
function renderPlayerName(username, activeSkinId) {
    ...
    // ---- ⚡ LIGHTNING STORM — chaqmoq chaqishi ----
    if (skinId === 'lightning_storm') {
        return `<span class="lightning-name-wrap">
            <span class="lightning-icon-box">⚡</span>
    ...
    if (skinId === 'fire_boss') {
        return `<span class="fire-name-wrap">
            <span class="fire-icon-box">
                🔥
                <span class="fire-p fire-p1"></span>
                <span class="fire-p fire-p2"></span>
                <span class="fire-p fire-p3"></span>
            </span>
            <span class="fire-text">${u}</span>
        </span>`;
    }

    // ---- 🌌 COSMIC NEBULA — yulduzlar miltillab ----
    if (skinId === 'cosmic_nebula') {
        return `<span class="cosmic-name-wrap">
            <span class="cosmic-icon-box">
                🌌
                <span class="star-dot sd1"></span>
                <span class="star-dot sd2"></span>
                <span class="star-dot sd3"></span>
                <span class="star-dot sd4"></span>
                <span class="star-dot sd5"></span>
                <span class="star-dot sd6"></span>
            </span>
            <span class="cosmic-text">${u}</span>
        </span>`;
    }

    // ---- 👑 KING — oltin nur shimmer ----
    if (skinId === 'king') {
        return `<span class="king-name-wrap">
            <span class="king-icon-box">
                👑
                <span class="gold-p gp1"></span>
                <span class="gold-p gp2"></span>
                <span class="gold-p gp3"></span>
                <span class="gold-p gp4"></span>
            </span>
            <span class="king-text">${u}</span>
        </span>`;
    }

    // ---- 🥷 NINJA — ko'rinib-ko'rinmay ----
    if (skinId === 'ninja') {
        return `<span class="ninja-name-wrap">
            <span class="ninja-icon-box">🥷</span>
            <span class="ninja-text">${u}</span>
        </span>`;
    }

    // ---- 👻 GHOST — suzib eriydi ----
    if (skinId === 'ghost') {
        return `<span class="ghost-name-wrap">
            <span class="ghost-icon-box">
                👻
                <span class="ghost-shadow"></span>
            </span>
            <span class="ghost-text">${u}</span>
        </span>`;
    }
    ...
    // ---- 🌹 ROSE GARDEN — gul ochilishi ----
    if (skinId === 'rose_garden') {
        return `<span class="rose-name-wrap">
            <span class="rose-icon-box">
                🌹
                <span class="rose-petal rp1"></span>
                <span class="rose-petal rp2"></span>
                <span class="rose-petal rp3"></span>
            </span>
            <span class="rose-text">${u}</span>
        </span>`;
    }
